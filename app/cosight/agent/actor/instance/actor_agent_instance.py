    ...
    template_content = {
        ...
        'skills': [execute_code_skill(work_space_path),
                #    search_baidu_skill(),
                   ...
                   # search_duckgo_skill(),
                   search_wiki_skill(),
                   wiki_first_revision_skill(),
                   wiki_revision_at_skill(),
                   wiki_reference_count_skill(),
                   wiki_revision_reference_delta_skill(),
                   wiki_infobox_field_lookup_skill(),
                   wiki_revision_size_delta_find_skill(),
                   wiki_rail_connection_count_skill(),
