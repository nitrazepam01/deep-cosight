...
ACTOR_SKILL_CATALOG: Dict[str, dict] = {
    ...
    "document_abstract_year_count": {
        ...
        "description_zh": "定位文档摘要边界，只在摘要中统计指定年份出现次数，并返回全文计数用于审计",
        "needs_workspace": False,
    },
    "create_html_report": {
...
def build_actor_skills(skill_names: List[str], work_space_path: str = None) -> list:
    ...
    from app.cosight.agent.actor.instance.actor_agent_skill import (
        ...
        document_abstract_year_count_skill, browser_use_skill,
    ...
    SKILL_BUILDERS = {
        ...
        "document_abstract_year_count": document_abstract_year_count_skill,
